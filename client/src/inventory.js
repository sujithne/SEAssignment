...
const InventoryList = (props) => {
    ...
    useEffect(() => {
        axios.get('http://18.235.62.53:3003/inventory')
    ...
    const handleDelete = (id) => {
        axios.delete(`http://18.235.62.53:3003/inventorys/${id}`)
            .then(() => {
    ...
    const handleEdit = (id) => {
        // setName(id.name);
        //setQty(qty);
        axios.get(`http://18.235.62.53:3003/inventorys/${id}`).then((response) => {
            setIid(id);
    ...
    const updateItem = () => {
        axios.put(`http://18.235.62.53:3003/inventorys/${iid}`, {
            name,
            quantity,
